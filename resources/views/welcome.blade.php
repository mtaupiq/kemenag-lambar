            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="service">
                    <ol>
                        ...
                        @endforeach
                        <a href=""><p class="mt-3 text-success">Pengumuman Lainnya</p></a>
                    </ol>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="col-md-3">
                                <article class="blog-post">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>{{ Str::limit(strip_tags($PostKantor->body, 10)) }}</p>
                                        <a href="{{ route('post.show', $PostKantor->slug) }}" class="ms-auto">Selengkapnya</a>
                                    </div>
                                </article>
                            </div>
                            @endforeach
                            ...
                            <div class="col-md-3">
                                <article class="blog-post">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5>{{ $PostKua->title }}</h5>
                                        <p>{{ Str::limit(strip_tags($PostKua->body, 10)) }}</p>
                                        <a href="{{ route('post.show', $PostKua->slug) }}" class="ms-auto">Selengkapnya</a>
                                    </div>
                                </article>
                            </div>
                            @endforeach
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <article class="blog-post">
                                    <img src="{{ asset('storage/'.$PostMadrasah->image) }}" alt="" height="170">
                                    <div class="content">
                                        <small>{{ $PostMadrasah->created_at->format('d M Y') }}</small>
                                        <h5>{{ $PostMadrasah->title }}</h5>
                                        <p>{{ Str::limit(strip_tags($PostMadrasah->body, 10)) }}</p>
                                        <a href="{{ route('post.show', $PostMadrasah->slug) }}" class="ms-auto">Selengkapnya</a>
                                    </div>
                                </article>
                            </div>
                            @endforeach
