            ...
            <div class="col-lg-12 mt-3">
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form class="form-horizontal" method="POST" action="{{ route('config.update', $config->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                              <div class="card-body">
                                  <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" id="ministry_name" name="ministry_name" value="{{ $config->ministry_name }}">
                                      </div>
                                  </div>
                                  <div class="form-group row">
                                    <label for="Logo" class="col-sm-2 col-form-label">Logo</label>
                                    <div class="col-sm-10">
                                      <input type="file" name="logo" class="form-control-file" id="logo"> <img src="{{ asset('storage/'.$config->logo) }}" alt="logo" width="200" value="{{ $config->logo }}" >
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="copyright" name="copyright" value="{{ $config->copyright }}">
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    <label for="Longitude" class="col-sm-2 col-form-label">Longitude</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Longitude" name="long" value="{{ $config->long }}">
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    <label for="Latitude" class="col-sm-2 col-form-label">Latitude</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="Latitude" name="lat" value="{{ $config->lat }}">
                                    </div>
                                  </div>
                                  <div class="form-group row">
