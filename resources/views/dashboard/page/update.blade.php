  ...
  <div class="container-fluid">
    <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title">Edit Page/Halaman</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form class="form-horizontal" action="{{ route ('page.update', $page->slug) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PATCH')
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea name="body" class="my-editor form-control @error('body') is-invalid @enderror" id="my-editor" cols="30" rows="10">{{ $page->body }}</textarea>
                @error('body')
                <p class="text-danger">{{ $message }}</p>
                @enderror
              </div>
