                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control" id="name" value="{{ (isset($category['name']))? $category['name'] : '' }}" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="url" class="form-control" id="url" value="{{ (isset($category['url']))? $category['url'] : '' }}" >
                            </div>
                          </div>
                    </div>
                </div>
