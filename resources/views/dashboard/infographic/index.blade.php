      ...
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td><img src="{{ asset('storage/'.$infographic->image) }}" alt="" height="50"></td>
            <td>
              <div class="btn-group">
                ...
                <div class="dropdown-menu" role="menu">
                  <a class="dropdown-item" href="{{ route('infographic.edit', $infographic->title) }}">Edit</a>
                
                  <form action="{{ route('infographic.destroy', $infographic->title) }}" method="POST">
                    @csrf
                    @method('DELETE')
