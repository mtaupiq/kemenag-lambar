  ...
  <div class="container-fluid">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <button type="button" class="btn btn-primary float-sm-right" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Tambah User</button>
      </div>
            ...
            <td>
              <div class="btn-group">
                ...
                <div class="dropdown-menu" role="menu">
                  <a class="dropdown-item" href="{{ route('user.edit', $user->email) }}">Edit</a>
                
                  @if($user->id == Auth::user()->id)
                  <button type="submit" class="btn btn-sm dropdown-item disabled">Delete</button>
                  @else
