  ...
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="/dashboard/infographic" class="nav-link {{ Request::is('dashboard/infographic')?'active' : ''  }}">
            <i class="far fa-circle nav-icon"></i>
    ...
    {{-- @if (Auth::check() && Auth::user()->email()== 'verisetiadi@gmail.com') --}}
    <li class="nav-item">
    ...
    <li class="nav-item">
      <form id="logout-form" action="{{ route('logout') }}" method="POST">
        ...
        <button type="submit" class="btn btn-sm btn-danger ml-3 mt-3"><i class="fas fa-user-slash"> Log Out</i></button>
    </form>
    </li>
  </ul>
